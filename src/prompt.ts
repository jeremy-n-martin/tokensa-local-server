...
export function buildPrompt({ age, tags, prenom, nom, homme }: Input) {
  ...
  return [
    ...
    "- Dans ce paragraphe, n'utilise jamais de tournures réservées à l'écriture comme « En production écrite » ou « En écriture » : tout le paragraphe doit se rapporter exclusivement à la lecture.",
    ...
    "- Ne répète pas ensuite cette tournure exacte dans les phrases suivantes : utilise des formulations variées pour éviter la redondance.",
    "- Dans ce paragraphe, n'utilise jamais les tournures de lecture comme « Lors des épreuves de lecture » : tout le paragraphe doit se rapporter exclusivement à l'écriture.",
